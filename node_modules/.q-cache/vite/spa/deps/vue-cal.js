...
var vt = { name: "vue-cal", components: { "vuecal-cell": se, "vuecal-header": Me, WeekdaysHeadings: ie, AllDayBar: je }, provide() {
  ...
  if (this.locale === "en") {
    const t = await import("./en.es-NB3N2QE6.js");
    ...
    })(Object.assign({ "./i18n/ar.json": () => import("./ar.es-OQUPG7MG.js"), "./i18n/bg.json": () => import("./bg.es-IRTYJXKY.js"), "./i18n/bn.json": () => import("./bn.es-LSWLIKUF.js"), "./i18n/bs.json": () => import("./bs.es-JWSNNV3R.js"), "./i18n/ca.json": () => import("./ca.es-GYKXZD63.js"), "./i18n/cs.json": () => import("./cs.es-JYQIH2YD.js"), "./i18n/da.json": () => import("./da.es-CKT4AR2I.js"), "./i18n/de.json": () => import("./de.es-4PBSMPLD.js"), "./i18n/el.json": () => import("./el.es-XITKPDX3.js"), "./i18n/en.json": () => import("./en.es-NB3N2QE6.js"), "./i18n/es.json": () => import("./es.es-TL7UL2PW.js"), "./i18n/et.json": () => import("./et.es-UYHA67T4.js"), "./i18n/fa.json": () => import("./fa.es-24HXBDK7.js"), "./i18n/fr.json": () => import("./fr.es-5VQ2I35B.js"), "./i18n/he.json": () => import("./he.es-ALXGIKRE.js"), "./i18n/hr.json": () => import("./hr.es-HT2PI4DQ.js"), "./i18n/hu.json": () => import("./hu.es-ONHEIUML.js"), "./i18n/id.json": () => import("./id.es-QLAKWNQH.js"), "./i18n/is.json": () => import("./is.es-F42TMSGO.js"), "./i18n/it.json": () => import("./it.es-GINMKCA7.js"), "./i18n/ja.json": () => import("./ja.es-IK6Q63BU.js"), "./i18n/ka.json": () => import("./ka.es-RXYWZ6RP.js"), "./i18n/ko.json": () => import("./ko.es-2IRNYT43.js"), "./i18n/lt.json": () => import("./lt.es-CIEJECEY.js"), "./i18n/mn.json": () => import("./mn.es-OQLWB7LK.js"), "./i18n/nl.json": () => import("./nl.es-CCI5XX2P.js"), "./i18n/no.json": () => import("./no.es-OLTTKZAY.js"), "./i18n/pl.json": () => import("./pl.es-TTA7IEFK.js"), "./i18n/pt-br.json": () => import("./pt-br.es-RAYPLK73.js"), "./i18n/ro.json": () => import("./ro.es-XHN4XDUV.js"), "./i18n/ru.json": () => import("./ru.es-F22JPK3G.js"), "./i18n/sk.json": () => import("./sk.es-OF7IDCQJ.js"), "./i18n/sl.json": () => import("./sl.es-RP2IVBEI.js"), "./i18n/sq.json": () => import("./sq.es-ZSVBWOHJ.js"), "./i18n/sr.json": () => import("./sr.es-AVMTANK3.js"), "./i18n/sv.json": () => import("./sv.es-TIQUZUCJ.js"), "./i18n/tr.json": () => import("./tr.es-HED46XS7.js"), "./i18n/uk.json": () => import("./uk.es-DIXMSX6H.js"), "./i18n/vi.json": () => import("./vi.es-LL4NAONC.js"), "./i18n/zh-cn.json": () => import("./zh-cn.es-GKG2J6WS.js"), "./i18n/zh-hk.json": () => import("./zh-hk.es-3V7WPXEA.js") }), `./i18n/${e}.json`).then((t) => {
      this.texts = Object.assign({}, z, t.default), this.utils.date.updateTexts(this.texts);
    });
}, loadDragAndDrop() {
  import("./drag-and-drop.es-MZ7TMDXM.js").then((e) => {
