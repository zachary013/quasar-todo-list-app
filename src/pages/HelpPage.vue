  ...
  <q-page padding>
    <q-card>
      <q-card-section>
        ...
        <p>
          This is a simple todo app to help you keep track of your tasks. If you
          have any questions or need further assistance, please visit our GitHub
          page.
        </p>
      </q-card-section>
    </q-card>
...
export default {
  ...
  methods: {
    openGithub() {
      window.open("https://github.com/zachary013", "_blank");
    },
  },
};
</script>
